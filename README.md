...
| 🔎 **[legwork](https://github.com/dbhq-uk/legwork)** | Multi-source research producing citation-tracked findings - evidence persistence, source credibility scoring and claim-level verification gates. Free built-in search first; paid fallback only when a page genuinely cannot be read |
